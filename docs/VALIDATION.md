...
| D54 | The generator's 4000-token output ceiling truncated the largest answers mid-JSON, and the repair attempt asked only for valid JSON so it truncated identically — P08 lost its written answer to the template, silently | **Fixed** (2026-08-06) | pending |
